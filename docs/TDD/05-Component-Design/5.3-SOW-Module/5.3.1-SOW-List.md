...
graph LR
    ...
    DB[("&lt;&lt;Database&gt;&gt;<br/>MongoDB Project")]

    UI_LIST -->|Request SOW list<br/>with filters| SEC
    SEC -.->|Validate & forward| SOW_SVC
    SOW_SVC -.->|Query sow collection| DB
    DB -.->|Return SOW records| SOW_SVC
    SOW_SVC -.->|Return SOW list data| UI_LIST
